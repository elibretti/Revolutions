...
class Canvas {
    constructor(){
        ...
        this.backgroundPicker = document.getElementById("background-color");
        ...
        this.backgroundPicker.onchange = this.handleBackground.bind(this)
    ...
    handleBackground(){
        ...
        `background-color:${this.backgroundPicker.value};`)
    }
}
...
/*!*************************!*\
  !*** ./lib/settings.js ***!
  \*************************/
/*! exports provided: colorPicker, backgroundPicker, widthPicker, divisionPicker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colorPicker", function() { return colorPicker; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "backgroundPicker", function() { return backgroundPicker; });
...
const backgroundPicker = () => {
    const picker = document.getElementById("background-color");
    return picker.value;
}
