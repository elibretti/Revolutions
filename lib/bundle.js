...
class Canvas {
    ...
    handleMove(e){
        if(this.draw){
            ...
            Object(_symmetry__WEBPACK_IMPORTED_MODULE_1__["circleSymmetry"])(Object(_settings__WEBPACK_IMPORTED_MODULE_0__["divisionPicker"])(), true, this.context, this.startDraw, this.width, this.height)
    ...
    handleDown(e){
        this.getCoordinates(e);
        Object(_symmetry__WEBPACK_IMPORTED_MODULE_1__["circlePointSymmetry"])(Object(_settings__WEBPACK_IMPORTED_MODULE_0__["divisionPicker"])(), true, this.context, this.drawCoordinates, this.width, this.height, this.endX, this.endY)
...
/*!*************************!*\
  !*** ./lib/symmetry.js ***!
  \*************************/
/*! exports provided: circleSymmetry, circlePointSymmetry, polygonPointSymmetry */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "polygonPointSymmetry", function() { return polygonPointSymmetry; });
...
const polygonPointSymmetry = ( sections = 2, mirror, context, startDraw, width, height, x, y) => {
    const c_x = width /2;
    const c_y = height / 2;
    let k;
