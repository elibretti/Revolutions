...
/* harmony import */ var _hideable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hideable */ "./lib/hideable.js");


document.addEventListener('DOMContentLoaded', () => {
    Object(_hideable__WEBPACK_IMPORTED_MODULE_1__["inputMenu"])();
...
class Canvas {
    constructor(){
     ...
     resizeCanvas(){
                ...
                this.width = this.canvas.width;
                this.height = this.canvas.height;
                const _x = (this.canvas.width - old_width) /2.0;
                const _y = (this.canvas.height -old_height) /2.0;
                var img=new Image();
                img.onload= () => {
                    this.context.imageSmoothingEnabled = false;
                    this.context.drawImage(img,_x,_y);
...
/*!*************************!*\
  !*** ./lib/hideable.js ***!
  \*************************/
/*! exports provided: inputMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "inputMenu", function() { return inputMenu; });
const inputMenu = () => {
